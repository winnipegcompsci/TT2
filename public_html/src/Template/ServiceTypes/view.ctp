...
<div class="serviceTypes view large-10 medium-9 columns">
    <h2><?= h($serviceType->name) ?></h2>
    <div class="row">
        <div class="large-5 columns strings">
            <h6 class="subheader"><?= __('Name') ?></h6>
            <p><?= h($serviceType->name) ?></p>
        </div>
        <div class="large-2 columns numbers end">
            <h6 class="subheader"><?= __('Id') ?></h6>
            <p><?= $this->Number->format($serviceType->id) ?></p>
            <h6 class="subheader"><?= __('Order') ?></h6>
            <p><?= $this->Number->format($serviceType->order) ?></p>
        </div>
    </div>
</div>
<div class="related row">
    ...
    <?php if (!empty($serviceType->tickets)): ?>
    <table cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($serviceType->tickets as $tickets): ?>
        <tr>
            <td><?= h($tickets->id) ?></td>
