...
class NotificationsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['NotificationTypes', 'UserRoles']
        ];
    ...
    public function add()
    {
        ...
        $userRoles = $this->Notifications->UserRoles->find('list', ['limit' => 200]);
        $this->set(compact('notification', 'notificationTypes', 'userRoles'));
        $this->set('_serialize', ['notification']);
    }
