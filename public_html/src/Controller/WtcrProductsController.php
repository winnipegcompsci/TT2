...
class WtcrProductsController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->WtcrProducts->save($wtcrProduct)) {
                $this->Flash->success(__('The wtcr product has been saved.'));
                return $this->redirect(['action' => 'index']);
            } else {
                $this->Flash->error(__('The wtcr product could not be saved. Please, try again.'));
            }
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->WtcrProducts->delete($wtcrProduct)) {
            $this->Flash->success(__('The wtcr product has been deleted.'));
        } else {
            $this->Flash->error(__('The wtcr product could not be deleted. Please, try again.'));
        }
        return $this->redirect(['action' => 'index']);
    }
}
