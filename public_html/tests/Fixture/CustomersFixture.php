...
class CustomersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'number' => ['type' => 'string', 'length' => 6, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'customer_notes_id' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'customer_number' => ['type' => 'unique', 'columns' => ['number'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
